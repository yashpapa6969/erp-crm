            ...
            <table class="waffle" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    ...
                    <tr style="height: 20px">
                        ...
                        <td class="s23" colspan="4">${slips.basicPay}</td>
                    </tr>
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s15" colspan="4">Travel Allowance</td>
                        <td class="s23" colspan="4">${slips.travelPay}</td>
                    </tr>
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s15" colspan="4">Bonus</td>
                        <td class="s23" colspan="4">${slips.bonus}</td>
                    </tr>
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s15" colspan="4">Leaves</td>
                        <td class="s23" colspan="4">${slips.paidLeave}</td>
                    </tr>
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s25" colspan="4">Total Income</td>
                        <td class="s26" colspan="4">${slips.totalIncome}</td>
                    </tr>
                    <!-- DEDUCTIONS Section -->
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                    ...
                    <tr style="height: 20px">
                        ...
                        <td class="s23" colspan="4">${slips.tds}</td>
                    </tr>
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s15" colspan="4">Leaves</td>
                        <td class="s23" colspan="4">${slips.totalLeaves}</td>
                    </tr>
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s15" colspan="4">Advance Salary</td>
                        <td class="s23" colspan="4">${slips.advanceSalary}</td>
                    </tr>
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s25" colspan="4">Total Deductions</td>
                        <td class="s24" colspan="4">${slips.totalDeductions}</td>
                    </tr>
                    <!-- Net Salary -->
                    <tr style="height: 20px">
                        <th style="height: 20px;" class="row-headers-background"></th>
                        <td class="s28" colspan="6">NET SALARY</td>
                        <td class="s29" colspan="2">${slips.concatnetSalary}</td>
                    </tr>
